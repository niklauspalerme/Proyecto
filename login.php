...
require_once('autoload.php');
  ...
  //Mientras Usuario no este login mostrara una imagen vacia
  ...
  if($_POST){
    ...
    $errores = Funciones::validar($_POST,'login');

    if(count($errores) == 0){

      $user = Consulta::buscarUsuario($pdo,"users",$_POST["email"]);
      ...
      if($user == null){
        ...
        if($_POST["password"]!=$user["password"]){
          $errores["password"]="Contraseña invalida";
            ...
            Funciones::seteoUsuario($user,$_POST);
          //aca me quede

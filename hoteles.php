    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
          <div class="row wow animated fadeIn" data-wow-duration="1s">
              <h1 class="display-4 col-md-12">Hoteles que son como estar en casa</h1>
              <hr class="my-4 col-md-12">
              <p class="lead col-md-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
          </div>
      </div>
    </div>
      ...
      <div class="row ">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 wow animated bounceInRight" data-wow-duration="1s">
          <div class="card" style="margin-bottom:15px">
            <img src="https://x.cdrst.com/foto/hotel-sf/2bda/granderesp/hotel-gran-hotel-buenos-aires-exterior-2fefde0.jpg" class="card-img-top" alt="...">
            <div class="card-body">

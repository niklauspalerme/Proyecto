...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <header>  <!-- Ini header -->
      ...
      <nav class="navbar navbar-expand-lg navbar-light nav-azul ml-auto d-flex fixed-top" style="background-color:#6fbffa;">
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <div class="row wow animated fadeIn" data-wow-duration="1s">
                <h1 class="display-4 col-md-12">Actividades que podés hacer like porteño</h1>
